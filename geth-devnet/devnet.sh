...
geth --rpc --rpcaddr "0.0.0.0" --rpccorsdomain "*" --rpcapi "db,eth,net,web3,personal,miner" --rpcvhosts "devnet" --dev --dev.period 1 --password ~/.accountpassword --mine --minerthreads 1 --extradata "Kunstmaan"
